...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-flex justify-between mx-auto p-1">
    <a href="cuentas.php" class="flex items-center">
        <img src="imagenes/Fondo_Form.jpg" class="h-8 mr-3" alt="Flowbite Logo" />
...
<center><h1>Agregar esquema de mayor</h1></center>
  ...
  //muestrame un boton que redireccione a la pagina de balanza con el id y el nombre de la cuenta
  echo '<a href="balanza.php?ID='.$ID.'&cuenta='.$cuenta.'" class="btn btn-success editbtn">Balanza de comprobacion</a>';
  echo '<br>';
  echo '<br>';
  echo '<a href="balance.php?ID='.$ID.'&cuenta='.$cuenta.'" class="btn btn-success editbtn">Balance General</a>';
  ?>
